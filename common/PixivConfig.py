...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("Network", "useMirrorHost", False),
        ConfigItem("Network", "mirrorHost", "i.pixiv.cat"),
        ConfigItem("Network", "mirrorMultithread", False),
        ConfigItem("Network", "mirrorThread", 4),
        ConfigItem("Network", "mirrorChunkSizeKB", 1024),
