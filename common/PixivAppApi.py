...
# Keep in sync with common/PixivOAuth.py behavior.
...
class PixivAppApiClient:
    ...
    def _oauth_refresh(self) -> PixivOauthToken:
        try:
            from common.PixivOAuthBrowser import CLIENT_ID, CLIENT_SECRET  # pylint: disable=import-error
        except Exception as exc:  # pragma: no cover
            raise RuntimeError("Missing common/PixivOAuthBrowser CLIENT_ID/CLIENT_SECRET") from exc
